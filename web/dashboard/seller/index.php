										...
										<div class="tab-content">
											<table class="table table-bordered table-striped table-sm">
												...
												<tbody>
													...
													<tr>
												    <td>Company Name</td>
														<td><input class="tos" type="text" id="cname" name="cname"></td>
													</tr>
													<tr>
										...
										<div class="tab-content">
											<table class="table table-bordered table-striped table-sm">
												...
												<tbody>
													...
													<tr>
												    <td>Address</td>
														<td><input class="dis" type="text" id="address" name="address"></td>
													</tr>
													<tr>
												    <td>City</td>
										...
										<div class="tab-content">
											<table class="table table-bordered table-striped table-sm">
												...
												<tbody>
													...
													<tr>
												    <td>Document1</td>
														<td><input class="tos" type="file" id="cname" name="cname"></td>
													</tr>
													<tr>
												    <td>Document2</td>
														<td><input class="tos" type="file" id="cperson" name="cperson"></td>
													</tr>
													<tr>
												    <td>Document3</td>
														<td><input class="tos" type="file" id="tan" name="tan"></td>
