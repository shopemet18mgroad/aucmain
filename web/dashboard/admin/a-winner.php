				...
				<div class="col-md-9">
					<div class="deals-tab-table">
							<ul class="nav nav-tabs border-0" id="myTab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active border border-primary border-bottom-0" id="hvd-tab" data-toggle="tab" href="#hvd" role="tab" aria-controls="hvd" aria-selected="true"><b>Bid Winner</b></a>
								</li>
							</ul>
                           <!--table-->
							...
							<div class="table-holder"> 
										...
										<table class="table table-bordered table-striped table-sm mt-2">
													...
													<tr>
														...
														<th class="uphead" width="10%">Date and Time</th>
												...
												<tbody>
													<tr>
														<td style="color:green;"><b>E687</b></td>
														<td style="color:green;"><b>BSP</b></td>
														<td style="color:green;"><b>SS Iron rod</b></td>
